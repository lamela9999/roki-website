  ...
  <footer className="footer">
    ...
    <div>
      ...
      <div className="footer-socials">
        ...
        <a href="https://dex.coinmarketcap.com/token/solana/J96hj2LiXw6UFPm7cpGQV99G5SJi4mpP7PQRZFC6brrr/" target="_blank" rel="noopener noreferrer" aria-label="CoinMarketCap">{CMC_ICON}</a>
      </div>
    </div>
    <div>
